...
int main(){
	...
	for(int i=0;i<3;i++)
	{
		for(int j=0;j<3;j++)
		{
			for(int k=0;k<3;k++)
			{
			cout<<"block["<<i<<"]["<<j<<"]["<<k<<"]= "<<"(c)="<<endl;
			cout<<block[i][j][k].c[0]<<","<<block[i][j][k].c[1]<<","<<block[i][j][k].c[2]<<endl<<"(v0)= ";
			cout<<block[i][j][k].v[0][0]<<","<<block[i][j][k].v[0][1]<<","<<block[i][j][k].v[0][2]<<endl<<"(v1)=";
			cout<<block[i][j][k].v[1][0]<<","<<block[i][j][k].v[1][1]<<","<<block[i][j][k].v[1][2]<<endl<<"(v2)=";
			cout<<block[i][j][k].v[2][0]<<","<<block[i][j][k].v[2][1]<<","<<block[i][j][k].v[2][2]<<endl;
		}
		}
	}*/
	
	//cout<<endl<<"face_matrix"<<endl;
	/*for(int i=0;i<6;i++)
	{
		for(int j=0;j<9;j++)
		{cout<<"face["<<i<<"]["<<j<<"] "<<" v1 =";
